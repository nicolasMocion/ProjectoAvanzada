  ...
  template: `
    <div class="page">
      <div class="page-header">
        ...
        <p class="text-muted">Historial completo de tus solicitudes académicas</p>
      </div>
          ...
          <table>
            ...
            <tbody>
              <tr *ngFor="let s of filtered">
                ...
                <td class="text-sm">{{ s.responsable?.nombre || 'Sin asignar' }}</td>
    ...
    <app-solicitud-detalle *ngIf="detalleId" [solicitudId]="detalleId" (close)="detalleId = null; cargar()"></app-solicitud-detalle>
  `,
  styles: [`
    .page { padding: 24px; }
